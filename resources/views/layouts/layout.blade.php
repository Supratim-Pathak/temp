            ...
            <aside class="app-sidebar">
                <div class="app-sidebar__logo">
                    <a class="header-brand" href="index.html">
                        <img src="{{ asset('assets/images/brand/logo.pn') }}g" class="header-brand-img desktop-lgo"
                            alt="Admintro logo">
                ...
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        <div class="user-pic">
                            <img src="{{ asset('assets/images/users/2.jpg') }}" alt="user-img"
                ...
                <ul class="side-menu app-sidebar3">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu ">
                            <li><a href="{{ route('RfqForm') }}" class="slide-item">Requisition Form</a></li>
                            <li><a href="{{ route('Rfqlist') }}" class="slide-item">Requisition List</a></li>
                        </ul>
                    </li>   
					<!-- WALLET END-->
@can('temp')
                    ...
                    @if(auth()->user()->can('view role') || auth()->user()->can('asign userBasedPermission') || auth()->user()->can('view permission')|| auth()->user()->can('asign roleToUser')|| auth()->user()->can('view permission'))
					<!-- ROLE PERMISSION -->
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu ">
                            @can('view role')
                                <li><a href="{{ route('roleList') }}" class="slide-item"> Role</a></li>
                            @endcan
                            @if(auth()->user()->can('revoke roleToUser') || auth()->user()->can('asign roleToUser'))
                                <li><a href="{{ route('asignRole') }}" class="slide-item">User Role management</a></li>
                            @endcan
                            @can('view permission')
                                <li><a href="{{ route('PermissionList') }}" class="slide-item">Permission</a></li>
                            @endcan
                            @can('asign userBasedPermission')
                                <li><a href="{{ route('userPermissionAsignList') }}" class="slide-item"> User Permission</a></li>
                            @endcan
                        </ul>
                    </li>   
					<!-- ROLE PERMISSION END-->
