            ...
            <aside class="app-sidebar">
                <div class="app-sidebar__logo">
                    <a class="header-brand" href="index.html">
                        <img src="<?php echo e(asset('assets/images/brand/logo.pn')); ?>g" class="header-brand-img desktop-lgo"
                            alt="Admintro logo">
                        <img src="<?php echo e(asset('assets/images/brand/logo1.png')); ?>" class="header-brand-img dark-logo"
                            alt="Admintro logo">
                        <img src="<?php echo e(asset('assets/images/brand/favicon.png')); ?>" class="header-brand-img mobile-logo"
                            alt="Admintro logo">
                        <img src="<?php echo e(asset('assets/images/brand/favicon1.png')); ?>" class="header-brand-img darkmobile-logo"
                            alt="Admintro logo">
                    </a>
                </div>
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        <div class="user-pic">
                            <img src="<?php echo e(asset('assets/images/users/2.jpg')); ?>" alt="user-img"
                ...
                <ul class="side-menu app-sidebar3">
					...
					<!-- WALLET -->
                    <li class="side-item side-item-category">FROMS</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                viewBox="0 0 24 24" width="24">
					...
					<!-- WALLET END-->
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('temp')): ?>
					<!-- ORDER -->
                    <li class="side-item side-item-category">Order</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
                            ...
                            <span class="side-menu__label">Order</span><i class="angle fa fa-angle-right"></i></a>
                        <ul class="slide-menu ">
                            <li><a href="#" class="slide-item"> Delhivery</a></li>
                            <li><a href="#" class="slide-item"> Ship Rocket</a></li>
                            <li><a href="#" class="slide-item"> Track Order</a></li>
                        </ul>
                    </li>   
					<!-- ORDER END-->
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
                            ...
                            <span class="side-menu__label"> Organization Report</span><i class="angle fa fa-angle-right"></i></a>
                        <ul class="slide-menu ">
                            <li><a href="calendar.html" class="slide-item"> Booking Report</a></li>
                        </ul>
                    </li>   
					<!-- ORDER END-->
					...
					<!-- ROLE PERMISSION -->
                    <li class="side-item side-item-category">Role & Permission</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                viewBox="0 0 24 24" width="24">
                        ...
                        <ul class="slide-menu ">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view role')): ?>
                                <li><a href="<?php echo e(route('roleList')); ?>" class="slide-item"> Role</a></li>
                            <?php endif; ?>
                            <?php if(auth()->user()->can('revoke roleToUser') || auth()->user()->can('asign roleToUser')): ?>
                                <li><a href="<?php echo e(route('asignRole')); ?>" class="slide-item">User Role management</a></li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view permission')): ?>
                                <li><a href="<?php echo e(route('PermissionList')); ?>" class="slide-item">Permission</a></li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('asign userBasedPermission')): ?>
                                <li><a href="<?php echo e(route('userPermissionAsignList')); ?>" class="slide-item"> User Permission</a></li>
                            <?php endif; ?>
                        </ul>
                    </li>   
					<!-- ROLE PERMISSION END-->
                    <?php endif; ?>
					<!-- SYSTEM SETEINGS -->        
					<li class="side-item side-item-category">System Settings</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                viewBox="0 0 24 24" width="24">
                        ...
                        <ul class="slide-menu ">
                            ...
                            <li class="sub-slide">
                                <a class="sub-side-menu__item" data-toggle="sub-slide" href="index-2.html#"><span
                                        class="sub-side-menu__label">Api Key</span><i
                                        class="sub-angle fe fe-chevron-down"></i></a>
                                <ul class="sub-slide-menu">
                                    <li><a class="sub-slide-item" href="chat.html">Razorpay Key</a></li>
                                    <li><a class="sub-slide-item" href="chat2.html">Delhivery Api key</a></li>
                                </ul>
                            </li>
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasRole('admin|Super-Admin')): ?>
                            <li><a href="calendar.html" class="slide-item"> Organization Information  </a></li>
                            <?php endif; ?>
                        </ul>
                    </li>  
<?php endif; ?>
                ...
                <div class="side-app">
                    ...
                    <div class="app-header header">
                        <div class="container-fluid">
                            <div class="d-flex">
                                <a class="header-brand" href="index.html">
                                    <img src="<?php echo e(asset('assets/images/brand/logo.png')); ?>" class="header-brand-img desktop-lgo"
                                        alt="Admintro logo">
                                    <img src="<?php echo e(asset('assets/images/brand/logo1.png')); ?>" class="header-brand-img dark-logo"
                                        alt="Admintro logo">
                                    <img src="<?php echo e(asset('assets/images/brand/favicon.png')); ?>" class="header-brand-img mobile-logo"
                                        alt="Admintro logo">
                                    <img src="<?php echo e(asset('assets/images/brand/favicon1.png')); ?>"
                                ...
                                <div class="d-flex order-lg-2 ml-auto">
                                    ...
                                    <div class="dropdown profile-dropdown">
                                        <a href="index-2.html#" class="nav-link pr-0 leading-none"
                                            ...
                                            <span>
                                                <img src="<?php echo e(asset('assets/images/users/2.jpg')); ?>" alt="img"
                        ...
                        <div class="page-leftheader">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="index-2.html#">Sales Dashboard</a></li>
                            </ol>
                        </div>
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2022 <a href="index-2.html#">Admintro</a>. Designed by <a
                            href="index-2.html#">Devant IT Solutions Pvt. Ltd.</a> All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
...
<?php /**PATH E:\laravel8_spati_rolePermission\resources\views/layouts/layout.blade.php ENDPATH**/ ?>