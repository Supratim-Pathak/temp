...
<div class="col-xl-12 col-lg-12 col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('RfqFormAction')); ?>">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label class="form-label">Requisition ID <span class="text-red">*</span></label>
                            <input type="text" class="form-control" name="req_id" value="<?php echo e($reqId); ?>" placeholder="Requisition ID" readonly required>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel8_spati_rolePermission\resources\views/appPages/users/rfqForms.blade.php ENDPATH**/ ?>