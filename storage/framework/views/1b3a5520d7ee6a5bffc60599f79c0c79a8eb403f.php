...
<div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('addRole')); ?>" novalidate>
                <?php echo csrf_field(); ?>
                <div class="">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel8_spati_rolePermission\resources\views/role/roleList.blade.php ENDPATH**/ ?>